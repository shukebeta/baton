...
mod imp {
    ...
    use super::records::{
        ...
        list_session_records, list_task_records, mark_task_start_rollback, read_session_record,
        read_task_record, reclaim_stale_requests, remove_session_record, responses_dir,
        sessions_dir, start_channel, take_task_start_response_locked, task_cancel_dir,
        task_channel, task_start_ack_exists, task_start_response_boundary_exists,
    ...
    fn run_service(control: &Path, task_retention_ms: u64, mut out: impl Write) -> Result<()> {
        ...
        loop {
            ...
            task_tick::tick_tasks::<UnixServicePlatform>(control, &mut tasks, &clock);
